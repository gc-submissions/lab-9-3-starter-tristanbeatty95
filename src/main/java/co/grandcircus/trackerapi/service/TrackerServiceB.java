...
public class TrackerServiceB implements TrackerService {
	private Stack<CountPair> tokens;
	...
	@Override
	public Stack<String> getLatest5() {
		Stack<String> latestFiveTokens = new Stack<>();
		String token;
		if (tokens.size() > 5) {
	...
	@Override
	public Stack<CountPair> getTop5() {
		
		Stack<CountPair> topFiveTokens = new Stack<>();
